...
ggbarplot(qPCR_summary, x = "Condition", "NFKB1",
       add = c("mean_se", "jitter"), error.plot = "upper_errorbar", palette = "npg", legend = "none", fill = "Condition", ylab = "Relative Expression", title = "NFKB1") +
...
ggbarplot(qPCR_summary, x = "Condition", "JNK1",
       add = c("mean_se", "jitter"), error.plot = "upper_errorbar", palette = "npg", legend = "none", fill = "Condition", ylab = "Relative Expression", title = "JNK1") +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 12)) +
  scale_y_continuous(expand = c(0,0), limits=c(0, 2)) +
theme(axis.text.x = element_text(color = "grey20", size = 12),
axis.text.y = element_text(color = "grey20", size = 16),
...
ggbarplot(qPCR_summary, x = "Condition", "JNK2",
       add = c("mean_se", "jitter"), error.plot = "upper_errorbar", palette = "npg", legend = "none", fill = "Condition", ylab = "Relative Expression", title = "JNK2") +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 12)) +
