...
ggbarplot(All_Data, x = "Condition", "IL-1B (pg/mg of protein)",
    add = c("mean_se", "jitter"), error.plot = "upper_errorbar", palette = "npg", legend = "none", fill = "Condition", ylims = c(0,100), title = "IL-1B in Media") +
  scale_y_continuous(expand = c(0,0)) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 12)) +
   theme_prism(base_size = 14) +
  theme(legend.position = "none") 
ggsave('C:/Users/fwestcott/OneDrive - Nexus365/Desktop/Results/HNM/Graphs/IL1B ELISA.png')
